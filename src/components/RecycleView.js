...
export default class RecycleView extends Component {
  constructor(props) {
    ...
    this.rowRenderer = (type, item) => {
      const { dvd_thumbnail_link, _id, film_type, title, wide_thunbnail_link } =
        item.item;
    ...
    return (
      <View style={styles.container}>
        <Text
          style={{
            color: "white",
            fontSize: this.props.from == "genre" ? 18 : 22,
        ...
        <RecyclerListView
          isHorizontal
          style={{ height: 250, marginLeft: 13 }}
